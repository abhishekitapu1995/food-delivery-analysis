...
checkpointLocation = "s3://stream-checkpointing-abhi/kinesisToRedshift/"
redshiftJdbcUrl = f"jdbc:redshift://movies.692859933703.us-east-1.redshift-serverless.amazonaws.com:5439/dev"
redshiftTable = "food_delivery_datamart.factOrders"
tempDir = "s3://redshift-temp-gds-abhi/temp-data/streaming_temp/"
